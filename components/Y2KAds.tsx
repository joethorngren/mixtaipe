    ...
    <div className="punch-flash" aria-hidden>
      <div className="punch-flash__stage">
        ...
        <div className="punch-flash__stars">
          <span className="punch-flash__star punch-flash__star--1">✦</span>
          <span className="punch-flash__star punch-flash__star--2">★</span>
          <span className="punch-flash__star punch-flash__star--3">✧</span>
          <span className="punch-flash__star punch-flash__star--4">✦</span>
          <span className="punch-flash__star punch-flash__star--5">★</span>
        </div>
